    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="border-t border-border">
        <div className="container py-16 md:py-24">
          <motion.div {...anim} className="max-w-[800px] space-y-14 md:space-y-20">
            <div className="space-y-6">
              <H2>The brief nobody wrote down</H2>
              <P>
                I had just moved to the UK, and this was my first music video
                since arriving. My English was still shaky, and on a set with
                five RED cameras, a director I deeply respected, and a room full
                of people who knew exactly what they were doing, that felt like
                a real problem. I kept thinking: if I mishear one instruction, I
            ...
            <div className="space-y-6">
              <H2>The brief: what was actually there</H2>
              <P>
                ...
                Above me in the chain of command sat Anthony as director and
                Ilya Maksymenko as DP, each almost certainly working from their
                own plan for the wider coverage. My job, as I understood it in
                the moment, was to read the room — to sense what each set-up
                needed rather than wait to be told.
              </P>
              <P>
                ...
                on a plan I couldn't see. So I stayed careful, watching for
                cues, trying not to be a problem on a set where everyone else
                looked completely certain.
              </P>
              <P>
                It didn't feel like confidence. It felt like walking on a set
                where I was the only one without the map — and the map, it
                turned out, wasn't the point.
              </P>
            </div>

            <div className="space-y-6">
              <H2>The moment that changed the shot</H2>
              <P>
                I went back to Anthony a second time and asked more directly:
                what do you actually want from my camera here? His answer was
                the same, just quieter: "Feel the moment. Listen to the music.
                Find your own shot."
              </P>
              <P>
                At that point I stopped waiting for permission. I picked up the
                camera, handheld, and found a starting position I liked. The
                choice was simple once I stopped overthinking it: a handheld
                move, close, alive, going straight through the scene rather than
                sitting outside it. I didn't discuss it with anyone first. I
                just committed.
              </P>
              <P>
                When Anthony called action, I started moving. A few seconds in,
                I heard him over the radio: "Yes, yes — keep going, that's it."
                That was the moment I stopped operating from anxiety and started
                operating from instinct — reading the emotional beat of the
                music rather than any rulebook of coverage or convention.
              </P>
              <P>
                Afterwards he put a hand on my shoulder, said "well done, follow
                me," and had me help block moves for two of the other cameras
                while he and the wider team kept building the scene. Watching
                that unfold from the inside — being trusted with someone else's
                shot, not just my own — was one of the more striking moments of
                the day.
              </P>
              <Figure
                src={bts2.url}
            ...
            <div className="space-y-6">
              <H2>What the decision actually protected</H2>
              <P>
                ...
                scene reads differently to a locked-off or planned camera
                watching from outside it. It gave that particular set-up
                presence rather than polish — closer to how the moment actually
                felt than to how it might have been storyboarded. That contrast,
                not any single technical choice, is what Anthony was responding
                to on the radio.
              </P>
              <P>
            ...
            <div className="space-y-6">
              ...
              <P>
                ...
                real time rather than to a fixed shot list. On a set that size,
                an operator's job isn't only to execute a frame — it's to know
                when to hold a plan and when a director is actually asking for a
                point of view.
              </P>
            </div>
            ...
            <div className="space-y-6">
              <H2>Reflection</H2>
              <P>
                A few things I took from that day, beyond the video itself:
              </P>
            ...
            <motion.aside {...anim} className="border border-border bg-card p-6 md:p-8">
