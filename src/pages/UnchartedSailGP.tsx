...
const project = {
  ...
  overview: [
    ...
    "Season 1 premiered on Prime Video on 23 June 2025.",
  ...
  approach: [
    ...
    "Working as cinematographer within the London crew required adaptability — shooting across water, dockside, and on board in rapidly changing conditions while keeping the visual language consistent and cinematic throughout.",
  ],
  reflection:
