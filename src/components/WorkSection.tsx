  ...
  return (
    <section className="relative h-screen w-full overflow-hidden border-t border-border">
      ...
      <button
        ...
        className="absolute left-4 top-1/2 z-20 -translate-y-1/2 text-foreground/30 hover:text-foreground/60 transition-colors duration-300 animate-[bounceLeft_2s_ease-in-out_infinite]"
        onClick={() => {
