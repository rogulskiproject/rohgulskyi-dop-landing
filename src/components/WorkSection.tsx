        ...
        <div className="mt-12 md:mt-16 overflow-x-auto">
          <div className="flex gap-4 md:gap-6 px-6 md:px-12 pb-4" style={{ minWidth: "max-content" }}>
            {placeholderProjects.map((project, i) => (
              ...
              >
                <div className="aspect-[3/2] bg-muted/40 border border-border/40 backdrop-blur-sm flex items-center justify-center group-hover:bg-accent/40 transition-colors overflow-hidden">
                  {project.hasVideo ? (
                    <iframe
